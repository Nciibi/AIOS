...
| Document ID | AIOS-BBL-002-VOI-001 |
...
|-------|--------|-------------|
| `VOI.STTStarted` | request_id, session_id, format, duration_ms, model | STT processing began |
| `VOI.STTCompleted` | request_id, session_id, transcript_length, confidence, language | Transcription finished |
| `VOI.STTFailed` | request_id, session_id, error_code, reason | Transcription failed |
| `VOI.STTStreamChunk` | request_id, session_id, partial_transcript, confidence, is_final | Streaming transcript chunk emitted |
| `VOI.STTLanguageDetected` | request_id, session_id, language, confidence | Language auto-detected |
| `VOI.STTSpeakerIdentified` | request_id, speaker_tag, duration_ms | New speaker detected in diarization |
| `VOI.STTProfanityFiltered` | request_id, total_masked, original_words | Profanity was masked |
| `VOI.STTCustomVocabApplied` | request_id, entries_matched, boosts_applied | Custom vocabulary influenced recognition |
| `VOI.STTAlternativeGenerated` | request_id, alternative_count | Alternative transcriptions produced |
| `VOI.STTStreamTimeout` | request_id, session_id, chunks_received, partial_transcript | Stream closed due to timeout |
| `VOI.STTModelChanged` | model_id, request_id | Streaming model switched mid-stream |
