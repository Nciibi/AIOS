...
|-----------|--------------|--------|
| `SDK.ProviderRegistered` | Provider registers with ROS | provider_id, provider_type, capabilities_hash |
| `SDK.ProviderHealthChanged` | Provider health status transitions | provider_id, from_status, to_status, reason |
| `SDK.ProviderResourceAllocated` | Resource is allocated | allocation_id, provider_id, resource_type, quantity |
| `SDK.ProviderResourceReleased` | Resource is released | allocation_id, provider_id, usage_summary |
| `SDK.ProviderCapabilityExecuted` | Capability execution completes | execution_id, provider_id, capability, result_summary |
| `SDK.ProviderDeregistered` | Provider is removed from registry | provider_id, reason, final_metrics |
