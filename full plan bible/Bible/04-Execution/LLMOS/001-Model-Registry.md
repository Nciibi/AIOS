...
| Document ID | AIOS-BBL-004-LLM-001 |
...
|-------|--------|---------|
| `LLMOS.ModelRegistered` | model_id, provider, capabilities, quality_tier | Provider initialization |
| `LLMOS.ModelDeregistered` | model_id, provider, reason | Provider disconnect or removal |
