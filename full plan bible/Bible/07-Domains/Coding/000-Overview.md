...
| `Coding.BuildCompleted` | Build operation finishes | build_id, outcome (pass/fail), duration_seconds |
| `Coding.CodebaseIndexed` | Codebase is indexed in Academy | index_id, repo_url, commit_hash, file_count |
| `Coding.TestRunCompleted` | Test suite execution finishes | test_run_id, passed, failed, skipped, coverage_pct |
| `Coding.CodePlanCreated` | A code plan is produced | plan_id, task_description, estimated_tokens, steps |
