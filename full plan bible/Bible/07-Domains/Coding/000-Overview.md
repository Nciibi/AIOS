...
|-----------|--------------|--------|
| COD.CodeGenerated |      Code is generated by a CodeWorker | worker_id, file_path, language, lines_added, lines_removed |
| COD.CodeReviewed |      Code review is completed | review_id, diff_hash, issues_found, confidence_score |
| COD.BuildCompleted |      Build operation finishes | build_id, outcome (pass/fail), duration_seconds, error_count |
| COD.CodebaseIndexed |      Codebase is indexed in Academy | index_id, repo_url, commit_hash, file_count, language_breakdown |
| COD.TestRunCompleted |      Test suite execution finishes | test_run_id, passed, failed, skipped, coverage_pct, duration_ms |
| COD.CodePlanCreated |      A code plan is produced | plan_id, task_description, estimated_tokens, steps, estimated_duration |
