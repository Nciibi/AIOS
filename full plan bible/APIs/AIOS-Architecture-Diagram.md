...
╚══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
 ...
 │                                                                                                             │
  ...
  │  │                                                                                                     │  │
  │  │  ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌────────────┐│  │
  │  │  │ Model      │─►│ Cost       │─►│ Router     │─►│ Cache      │─►│ Context    │─►│ Memory     │─►│ Prompt     ││  │
  │  │  │ Registry   │  │ Optimizer  │  │ (Score &   │  │ Lookup     │  │ Builder    │  │ Injection  │  │ Compiler   ││  │
  │  │  │ (Health,   │  │ (Estimate) │  │  Select)   │  │ (Exact +   │  │ (Window    │  │ (Mem OS)   │  │ (Template) ││  │
